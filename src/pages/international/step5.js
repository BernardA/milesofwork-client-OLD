            ...
            <div className="container">
                ...
                <main>
                    ...
                    {error ? (
                        ...
                        <>
                            <form
                                name="putCandidateStep5Form"
                                onSubmit={handleSubmit(this.submitStep)}
                            >
                                <TableContainer component={Paper}>
                                    <Table aria-label="simple table">
                                        <TableHead className={classes.MuiTableHeadRoot}>
                                            <TableRow
...
const mapStateToProps = (state) => {
    return {
        putCandidateStep5Form: state.form.putCandidateStep5Form,
...
export default connect(
    ...
    reduxForm({
        form: 'putCandidateStep5Form',
    })(withRouter(withStyles(styles)(withCookies(Step5)))),
);